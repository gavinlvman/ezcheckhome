...
const FALLBACK_TESTIMONIALS = [
  {
    ...
    property: '新婚夫婦・日出康城',
    rating: 5,
    comment: '我和太太首次置業，對驗樓完全是零經驗，幸好有「EZ Check Home」幫忙！驗樓師 Peter 哥超細心，連牆角的小裂縫、窗邊的膠條老化都一一指出來，還教我們很多保養小貼士。整個過程很專業，報告也寫得很詳細，讓我們收樓收得好安心！強烈推薦給所有新婚夫婦！'
  },
  {
    name: '投資者 王先生',
    property: '資深投資者・YOHO WEST',
    rating: 5,
    comment: '作為一名資深物業投資者，時間就是金錢。「EZ Check Home」的配對效率很高，很快就安排了經驗豐富的 John 師傅。他不僅驗樓速度快，而且對新樓常見問題瞭如指掌，提出的修繕建議也很到位。報告簡潔明瞭，讓我能迅速與發展商溝通，節省了不少寶貴時間。下次投資新盤，還會找他們。'
  },
  {
    name: '首置青年 阿樂',
    property: '首置人士・啟德發展區',
    rating: 5,
    comment: '第一次買樓，心情既興奮又緊張，最怕就是收樓時遇到問題。透過「EZ Check Home」找到的 Mary 師傅人很好，很有耐性地解釋每個檢測項目，讓我這個新手也能明白。她發現了一些水電的小瑕疵，幸好及早發現並要求發展商修復，讓我住得更安心。真的很感謝「EZ Check Home」，幫我省去了很多煩惱！'
  },
  {
    name: '換樓家庭 梁生',
    property: '換樓家庭・大圍柏傲莊',
    rating: 5,
    comment: '我們一家四口換了個大單位，對居住品質要求更高。選擇「EZ Check Home」是因為他們口碑不錯，而且價格透明。驗樓師的服務非常到位，不僅仔細檢查了每個房間，還特別留意了廚房和浴室的防水問題。報告出來後，我們對新家的狀況一目了然，覺得這筆驗樓費花得很值得，性價比很高！'
  },
  {
    name: '退休人士 張伯',
    property: '退休人士・九龍灣新盤',
    rating: 5,
    comment: '我年紀大了，對新科技不太懂，但「EZ Check Home」的客服很有耐心，一步步教我如何預約。驗樓師準時到達，態度和藹，檢查得很仔細。雖然有些小問題，但都及時發現並記錄下來。整個服務過程很順暢，讓我這個老人家也覺得很方便、很放心。'
  }
];
